...
VALUES
    ('d54e9d14-fd3c-4936-8d7f-66b8f48e8661', NULL, NOW(), 'admin@fitness.vn', NULL,
    ...
    ('9cb2ed6a-1753-4232-9c5c-8c523e32546e', NULL, NOW(), 'nguyenhanhtuan1206@gmail.com', NULL,
        '$2a$10$8LZTNRd9SbEz8ra53nQGtOYrNntm1AA75jv294mxuxyj6/q6jLSi2', '0903703541', FALSE, 'Anh Tuan 1'),
    ('054cbe26-67b7-4ead-b4f7-e72687d5f3ac', NULL, NOW(), 'tuannguyen@gmail.com', NULL,
        '$2a$10$8LZTNRd9SbEz8ra53nQGtOYrNntm1AA75jv294mxuxyj6/q6jLSi2', '0903703541', FALSE, 'Anh Tuan 2');

-- Seed Data for User Roles
INSERT INTO users_roles (user_id, role_id)
VALUES
    ((SELECT id FROM users WHERE email = 'admin@fitness.vn'), 1),
